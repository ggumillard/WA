          ...
          <div className="menusContainer">
            <div className="item">
              <div className="menu">
                ...
                <ul>
                  <li>
                    <a
                      href="https://about.meta.com/company-info/"
                      target="_blank"
                    >
                      Company info
                    </a>
                  ...
                  <li>
                    <a href="https://www.metacareers.com/faq" target="_blank">
                      Careers FAQs
                    </a>
                  </li>
                  <li>
                    <a
                      href="https://facebook.talentnet.community/"
                      target="_blank"
                    >
            ...
            <div className="item">
              <div className="menu">
                ...
                <ul>
                  <li>
                    <a
                      href="https://www.facebook.com/lifeatmeta/"
                      target="_blank"
                    >
                      Facebook
                    </a>
                  ...
                  <li>
                    <a
                      href="https://www.instagram.com/lifeatmeta/"
                      target="_blank"
                    >
                      Instagram
                    </a>
                  ...
                  <li>
                    <a
                      href="https://www.linkedin.com/company/meta"
                      target="_blank"
                    >
                      Linkedin
                    </a>
            ...
            <div className="item">
              <div className="menu">
                ...
                <ul>
                  <li>
                    <a
                      href="https://www.metacareers.com/privacy/"
                      target="_blank"
                    >
                  ...
                  <li>
                    <a
                      href="https://www.metacareers.com/policy/cookies/"
                      target="_blank"
                    >
                      Cookies
                    </a>
                  ...
                  <li>
                    <a
                      href="https://www.metacareers.com/policy/vaccination/"
                      target="_blank"
                    >
                      Vaccination entry policy
                    </a>
                  </li>
                </ul>
              </div>
            ...
            <div className="item">
              <div className="menu">
                ...
                <ul>
                  <li>
                    <a href="https://www.facebook.com/safety" target="_blank">
            ...
            <div className="item">
              <div className="report_bug">
                <svg
                  ...
                  viewBox="0 0 501.665 501.665"
                  xmlSpace="preserve"
                >
                  <g>
                    <g>
                      <path
                        d="M485.149,381.442l-10.133-37.653c-5.547-21.333-18.88-39.787-37.547-51.52l-21.013-13.12
